...
def _allocate_rollout_engine_addr_and_ports_normal(*, args, num_engines, rollout_engines):
    ...
    print(f"num_engines_per_node: {num_engines_per_node}")
    print(f"num_engines: {num_engines}")
    print(f"rollout_engines: {rollout_engines}")
    print(f"args.num_gpus_per_node: {args.num_gpus_per_node}")
    print(f"args.rollout_num_gpus: {args.rollout_num_gpus}")
    print(f"args.rollout_num_gpus_per_engine: {args.rollout_num_gpus_per_engine}")
    print(f"args.prefill_num_servers: {args.prefill_num_servers}")
    print(f"args.sglang_dp_size: {args.sglang_dp_size}")
    ...
    for rank, engine in rollout_engines:
        print(f"rank: {rank}, engine: {engine}")
        ...
        print(f"num_engines_on_this_node: {num_engines_on_this_node}")
