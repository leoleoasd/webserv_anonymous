...
# export DATASET_PATH=s3://YOUR_BUCKET/rl_web_agent/sft_data_curation/data_fix/
...
# export CHECKPOINT_PATH=s3://YOUR_BUCKET/rl_web_agent/sft_data_curation/checkpoints/$JOB_NAME
